package br.gov.pi.ati.adapi;

import br.gov.pi.ati.adapi.dao.controleacesso.PermissaoDAO;
...
public class GeracaoPermissao {
    ...
    public void generate() {
        ...
        //Animal
        create(new Permissao("animal", "Animal", false), "cadastro");
        create(new Permissao("animal.create", "Cadastro de Animal", "/view/cadastro/animal/createAnimal.jsf", false), "animal");
        create(new Permissao("animal.list", "Animais", "/view/cadastro/animal/listAnimal.jsf", true), "cadastro");
        create(new Permissao("animal.audit", "Auditoria de Animal"), "animal");
        create(new Permissao("animal.delete", "Exclusão de Animal"), "animal");

//Especie
        create(new Permissao("especie", "Especie", false), "cadastro");
        create(new Permissao("especie.create", "Cadastro de Especie", "/view/cadastro/especie/createEspecie.jsf", false), "especie");
        create(new Permissao("especie.list", "Espécies", "/view/cadastro/especie/listEspecie.jsf", true), "cadastro");
...
//Sinal Clinico
        create(new Permissao("sinalClinico", "Sinal Clinico", false), "cadastro");
        create(new Permissao("sinalClinico.create", "Cadastro de Sinal Clinico", "/view/cadastro/sinalClinico/createSinalClinico.jsf", false), "sinalClinico");
        create(new Permissao("sinalClinico.list", "Sinais Clínicos", "/view/cadastro/sinalClinico/listSinalClinico.jsf", true), "cadastro");
        create(new Permissao("sinalClinico.audit", "Auditoria de Sinal Clinico"), "sinalClinico");
        create(new Permissao("sinalClinico.delete", "Exclusão de Sinal Clinico"), "sinalClinico");

        //Notificacao
        create(new Permissao("notificacaoMenu", "Notificacão", true), null);
        
        create(new Permissao("notificacao", "Notificacão Submenu", false), "notificacaoMenu");
        create(new Permissao("notificacao.create", "Cadastro de Notificacao", "/view/notificacao/notificacao/createNotificacao.jsf", false), "notificacao");
        create(new Permissao("notificacao.list", "Notificações", "/view/notificacao/notificacao/listNotificacao.jsf", true), "notificacaoMenu");
        create(new Permissao("notificacao.audit", "Auditoria de Notificacao"), "notificacao");
        create(new Permissao("notificacao.delete", "Exclusão de Notificacao"), "notificacao");
