package br.gov.pi.ati.adapi.maker;

import br.gov.pi.ati.adapi.mb.padrao.ClassMB;
...
public class Maker extends MakerSwingFrame {
    ...
    public String getDefaultPackage() {
        return "br.gov.pi.ati.adapi.modelo";
    }
    ...
    public String getDefaultBaseDAOImpl() {
        return "br.gov.pi.ati.adapi.application.BaseDAOImpl";
    }
