package br.gov.pi.ati.agendacultural.maker;

import br.gov.pi.ati.agendacultural.mb.padrao.ClassMB;
...
public class Maker extends MakerSwingFrame {
    ...
    public String getDefaultPackage() {
        return "br.gov.pi.ati.agendacultural.modelo";
    }
    ...
    public String getDefaultBaseDAOImpl() {
        return "br.gov.pi.ati.agendacultural.application.BaseDAOImpl";
    }
