package br.gov.pi.ati.ati_guard.maker;

import br.gov.pi.ati.ati_guard.mb.padrao.ClassMB;
...
public class Maker extends MakerSwingFrame {
    ...
    public String getDefaultPackage() {
        return "br.gov.pi.ati.ati_guard.modelo";
    }
    ...
    public String getDefaultBaseDAOImpl() {
        return "br.gov.pi.ati.ati_guard.application.BaseDAOImpl";
    }
