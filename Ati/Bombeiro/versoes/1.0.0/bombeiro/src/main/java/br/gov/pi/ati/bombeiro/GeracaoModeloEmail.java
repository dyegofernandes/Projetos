package br.gov.pi.ati.bombeiro;

import br.gov.pi.ati.bombeiro.dao.DAO;
...
public class GeracaoModeloEmail {
    ...
    public void generate() {
        ...
        if (configuracaoEmail == null) {
            ...
            configuracaoEmail.setNome("[bombeiro]");
        ...
        salvarModeloEmail("[bombeiro] Cadastro de Usuario", TipoAssuntoEmail.NOVO_USUARIO_SISTEMA, configuracaoEmail);
        salvarModeloEmail("[bombeiro] Recuperacao de Senha", TipoAssuntoEmail.RECUPERACAO_SENHA, configuracaoEmail);
    }
