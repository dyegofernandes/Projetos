package br.gov.pi.ati.bombeiro.bo.email;

import br.gov.pi.ati.bombeiro.bo.configuracao.ErroSistemaBO;
import br.gov.pi.ati.bombeiro.modelo.email.Attachment;
