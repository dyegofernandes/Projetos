package br.gov.pi.ati.bombeiro.maker;

import br.gov.pi.ati.bombeiro.mb.padrao.ClassMB;
...
public class Maker extends MakerSwingFrame {
    ...
    public String getDefaultPackage() {
        return "br.gov.pi.ati.bombeiro.modelo";
    }
    ...
    public String getDefaultBaseDAOImpl() {
        return "br.gov.pi.ati.bombeiro.application.BaseDAOImpl";
    }
