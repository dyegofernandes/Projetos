package br.gov.pi.ati.cfcpm.maker;

import br.gov.pi.ati.cfcpm.mb.padrao.ClassMB;
...
public class Maker extends MakerSwingFrame {
    ...
    public String getDefaultPackage() {
        return "br.gov.pi.ati.cfcpm.modelo";
    }
    ...
    public String getDefaultBaseDAOImpl() {
        return "br.gov.pi.ati.cfcpm.application.BaseDAOImpl";
    }
