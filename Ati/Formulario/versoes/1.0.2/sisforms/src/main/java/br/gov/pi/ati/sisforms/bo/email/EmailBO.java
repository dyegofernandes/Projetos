package br.gov.pi.ati.sisforms.bo.email;

import br.gov.pi.ati.sisforms.bo.configuracao.ErroSistemaBO;
import br.gov.pi.ati.sisforms.modelo.email.Attachment;
