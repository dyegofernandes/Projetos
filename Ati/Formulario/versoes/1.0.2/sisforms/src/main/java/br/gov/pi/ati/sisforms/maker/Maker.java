package br.gov.pi.ati.sisforms.maker;

import br.gov.pi.ati.sisforms.mb.padrao.ClassMB;
...
public class Maker extends MakerSwingFrame {
    ...
    public String getDefaultPackage() {
        return "br.gov.pi.ati.sisforms.modelo";
    }
    ...
    public String getDefaultBaseDAOImpl() {
        return "br.gov.pi.ati.sisforms.application.BaseDAOImpl";
    }
