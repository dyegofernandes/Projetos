package br.gov.pi.ati.sisrh.maker;

import br.gov.pi.ati.sisrh.mb.padrao.ClassMB;
...
public class Maker extends MakerSwingFrame {
    ...
    public String getDefaultPackage() {
        return "br.gov.pi.ati.sisrh.modelo";
    }
    ...
    public String getDefaultBaseDAOImpl() {
        return "br.gov.pi.ati.sisrh.application.BaseDAOImpl";
    }
