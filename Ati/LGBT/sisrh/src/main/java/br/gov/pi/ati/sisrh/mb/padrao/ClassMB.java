package br.gov.pi.ati.sisrh.mb.padrao;

import br.gov.pi.ati.sisrh.modelo.cadastro.AcolhimentoTriagemLgbt;
import br.gov.pi.ati.sisrh.modelo.cadastro.AgendamentoTriagem;
import br.gov.pi.ati.sisrh.modelo.cadastro.ArquivoLGBT;
...
import br.gov.pi.ati.sisrh.modelo.cadastro.ProfissionalDeReferenciaFichaVisita;
...
import br.gov.pi.ati.sisrh.modelo.cadastro.enums.ComQuemMora;
import br.gov.pi.ati.sisrh.modelo.cadastro.enums.EstadoCivil;
import br.gov.pi.ati.sisrh.modelo.cadastro.enums.Etnia;
import br.gov.pi.ati.sisrh.modelo.cadastro.enums.IdentidadeGenero;
import br.gov.pi.ati.sisrh.modelo.cadastro.enums.OrientacaoSexual;
import br.gov.pi.ati.sisrh.modelo.cadastro.enums.Religiao;
import br.gov.pi.ati.sisrh.modelo.cadastro.enums.RendaFamiliar;
import br.gov.pi.ati.sisrh.modelo.cadastro.enums.ResideEm;
import br.gov.pi.ati.sisrh.modelo.cadastro.enums.Sexo;
import br.gov.pi.ati.sisrh.modelo.cadastro.enums.SimOuNao;
import br.gov.pi.ati.sisrh.modelo.cadastro.enums.SimOuNaoOutros;
import br.gov.pi.ati.sisrh.modelo.cadastro.enums.Solicitante;
import br.gov.pi.ati.sisrh.modelo.cadastro.enums.TipoDeServicoLgbt;
import br.gov.pi.ati.sisrh.modelo.cadastro.enums.TipoMoradia;
import br.gov.pi.ati.sisrh.modelo.cadastro.enums.TipoProfissional;
import br.gov.pi.ati.sisrh.modelo.cadastro.enums.TodosDocumento;
import br.gov.pi.ati.sisrh.modelo.controleacesso.Permissao;
...
import br.gov.pi.ati.sisrh.modelo.email.TipoAssuntoEmail;
import br.gov.pi.ati.sisrh.modelo.controleacesso.TipoRecuperacaoSenha;
