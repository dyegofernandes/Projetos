package br.gov.pi.ati.passelivre.maker;

import br.gov.pi.ati.passelivre.mb.padrao.ClassMB;
...
public class Maker extends MakerSwingFrame {
    ...
    public String getDefaultPackage() {
        return "br.gov.pi.ati.passelivre.modelo";
    }
    ...
    public String getDefaultBaseDAOImpl() {
        return "br.gov.pi.ati.passelivre.application.BaseDAOImpl";
    }
