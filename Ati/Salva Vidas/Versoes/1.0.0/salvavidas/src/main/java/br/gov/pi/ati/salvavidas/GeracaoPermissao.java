package br.gov.pi.ati.salvavidas;

import br.gov.pi.ati.salvavidas.dao.controleacesso.PermissaoDAO;
...
public class GeracaoPermissao {
    ...
    public void generate() {
        ...
        create(new Permissao("denuncia.create", "Cadastro de Denúncias", "/view/denuncia/denuncia/createDenuncia.jsf", false), "denuncia");
        create(new Permissao("denuncia.list", "Listar", "/view/denuncia/denuncia/listDenuncia.jsf", true), "denuncia");
        create(new Permissao("denuncia.audit", "Auditoria de Denúncias"), "denuncia");
        create(new Permissao("denuncia.delete", "Exclusão de Denúncias"), "denuncia");
        create(new Permissao("denuncia.cadastrarDenuncia", "Cadastrar", "/view/denuncia/denuncia/cadastrarDenuncia.jsf", true), "denuncia");

        //Fonte Recurso
        create(new Permissao("fonteRecurso", "Fonte Recurso", true), null);
        create(new Permissao("fonteRecurso.create", "Cadastro de Fonte Recurso", "/view/cadastro/fonteRecurso/createFonteRecurso.jsf", true), "fonteRecurso");
        create(new Permissao("fonteRecurso.list", "Consulta de Fonte Recurso", "/view/cadastro/fonteRecurso/listFonteRecurso.jsf", true), "fonteRecurso");
        create(new Permissao("fonteRecurso.audit", "Auditoria de Fonte Recurso"), "fonteRecurso");
        create(new Permissao("fonteRecurso.delete", "Exclusão de Fonte Recurso"), "fonteRecurso");
