package br.gov.pi.ati.salvavidas.bo.email;

import br.gov.pi.ati.salvavidas.bo.configuracao.ErroSistemaBO;
import br.gov.pi.ati.salvavidas.modelo.email.Attachment;
