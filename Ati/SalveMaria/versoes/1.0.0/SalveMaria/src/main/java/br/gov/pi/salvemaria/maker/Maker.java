package br.gov.pi.salvemaria.maker;

import br.gov.pi.salvemaria.mb.padrao.ClassMB;
...
public class Maker extends MakerSwingFrame {
    ...
    public String getDefaultPackage() {
        return "br.gov.pi.salvemaria.modelo";
    }
    ...
    public String getDefaultBaseDAOImpl() {
        return "br.gov.pi.salvemaria.application.BaseDAOImpl";
    }
