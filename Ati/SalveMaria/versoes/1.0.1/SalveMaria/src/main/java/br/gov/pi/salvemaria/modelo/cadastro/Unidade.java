...
public class Unidade implements Serializable {
    ...
    @ManyToOne(fetch = FetchType.LAZY)
    private Circunscricao_Bairro circunscricaoBairro;
...
//        }
    ...
    public Circunscricao_Bairro getCircunscricaoBairro() {
        return circunscricaoBairro;
    }

    public void setCircunscricaoBairro(Circunscricao_Bairro circunscricaoBairro) {
