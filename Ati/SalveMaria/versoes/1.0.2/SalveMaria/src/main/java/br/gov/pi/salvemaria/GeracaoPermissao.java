...
public class GeracaoPermissao {
    ...
    public void generate() {
         ...
         * Denúncias dos Sistema
         */
        create(new Permissao("relatorio", "Relatório", true), null);
...
//Unidade
        ...
        //Viatura
        create(new Permissao("viatura", "Viatura", false), "cadastrobasico");
        create(new Permissao("viatura.create", "Cadastro de Viatura", "/view/cadastro/viatura/createViatura.jsf", false), "viatura");
        create(new Permissao("viatura.list", "Viaturas", "/view/cadastro/viatura/listViatura.jsf", true), "cadastrobasico");
        ...
        //Circunscricao
        create(new Permissao("circunscricao", "Por Cidade", false), "circunscricaoPai");
        create(new Permissao("circunscricao.create", "Cadastro de Circunscrição por Cidade", "/view/cadastro/circunscricao/createCircunscricao.jsf", false), "circunscricao");
        create(new Permissao("circunscricao.list", "Por Cidades", "/view/cadastro/circunscricao/listCircunscricao.jsf", true), "circunscricaoPai");
        create(new Permissao("circunscricao.audit", "Auditoria de Circunscrição por Cidade"), "circunscricao");
        create(new Permissao("circunscricao.delete", "Exclusão de Circunscrição por Cidade"), "circunscricao");

        //Circunscricao Bairro
        create(new Permissao("circunscricao_Bairro", "Por Bairro", false), "circunscricaoPai");
        create(new Permissao("circunscricao_Bairro.create", "Cadastro de Território por Bairro", "/view/cadastro/circunscricao_Bairro/createCircunscricao_Bairro.jsf", false), "circunscricao_Bairro");
        create(new Permissao("circunscricao_Bairro.list", "Por Bairros", "/view/cadastro/circunscricao_Bairro/listCircunscricao_Bairro.jsf", true), "circunscricaoPai");
        create(new Permissao("circunscricao_Bairro.audit", "Auditoria de Território por Bairro"), "circunscricao_Bairro");
        create(new Permissao("circunscricao_Bairro.delete", "Exclusão de Território por Bairro"), "circunscricao_Bairro");

        create(new Permissao("relatorio.denunciaPorUnidade", "Denúncia Por Unidade", "/view/relatorios/relatorioDenunciaPorUnidade.jsf", true), "relatorio");
        create(new Permissao("relatorio.denunciaPorTerritorio", "Denúncia Por TD", "/view/relatorios/relatorioDenunciaPorTerritorio.jsf", true), "relatorio");
        create(new Permissao("relatorio.denunciaPorFormaViolencia", "Denúncia Forma Violência", "/view/relatorios/relatorioDenunciaPorFormaDeViolencia.jsf", true), "relatorio");
        create(new Permissao("relatorio.denunciaPorTerritorioEFormaViolencia", "Distribuição Violência por TD", "/view/relatorios/relatorioDenunciaPorTerritorioEformaViolencia.jsf", true), "relatorio");
