...
//    private Circunscricao circunscricao;
    ...
    @NotAudited
    @OneToMany(mappedBy = "cidade")
    private List<CircunscricaoBairro> circus_bairros;

    @ManyToMany(targetEntity = Circunscricao.class, mappedBy = "cidades")
...
//        }
    ...
    public List<CircunscricaoBairro> getCircus_bairros() {
        return circus_bairros;
    }

    public void setCircus_bairros(List<CircunscricaoBairro> circus_bairros) {
