 ...
 * 
 */
@WebServiceClient(name = "server.webservices", targetNamespace = "urn:server.webservices", wsdlLocation = "http://www.protocolo.pi.gov.br/webserver/server_process.php?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://www.protocolo.pi.gov.br/webserver/server_process.php?wsdl");
