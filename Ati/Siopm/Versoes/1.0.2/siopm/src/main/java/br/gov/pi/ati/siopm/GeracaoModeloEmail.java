...
import br.gov.pi.ati.siopm.dao.DAO;
...
public class GeracaoModeloEmail {
    ...
    public void generate() {
        ...
        if (configuracaoEmail == null) {
            ...
            configuracaoEmail.setNome("[siopm]");
        ...
        salvarModeloEmail("[siopm] Cadastro de Usuario", TipoAssuntoEmail.NOVO_USUARIO_SISTEMA, configuracaoEmail);
        salvarModeloEmail("[siopm] Recuperacao de Senha", TipoAssuntoEmail.RECUPERACAO_SENHA, configuracaoEmail);
    }
