package br.gov.pi.ati.siopm.maker;

import br.gov.pi.ati.siopm.mb.padrao.ClassMB;
...
public class Maker extends MakerSwingFrame {
    ...
    public String getDefaultPackage() {
        return "br.gov.pi.ati.siopm.modelo";
    }
    ...
    public String getDefaultBaseDAOImpl() {
        return "br.gov.pi.ati.siopm.application.BaseDAOImpl";
    }
