...
import br.gov.pi.ati.siopm.bo.cadastro.TransitoBO;
...
@ManagedBean
@ViewScoped
public class TransitoMB extends AbstractBaseBean<Transito> implements Serializable {

    @EJB
    private TransitoBO transitoBO;
