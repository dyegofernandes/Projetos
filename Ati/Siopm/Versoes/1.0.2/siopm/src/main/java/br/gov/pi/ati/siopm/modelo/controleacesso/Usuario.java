package br.gov.pi.ati.siopm.modelo.controleacesso;
...
public class Usuario implements Serializable, User {
    ...
    @ManyToMany(targetEntity = Perfil.class, fetch = FetchType.LAZY)
    @JoinTable(name = "usuario_perfildefinitivo", joinColumns = @JoinColumn(name = "usuario_id"), inverseJoinColumns = @JoinColumn(name = "perfil_id"))
    private List<Perfil> perfisDefinitivo;
...
//    private List<Ocorrencia> ocorrencias;
    ...
    public List<Perfil> getPerfisDefinitivo() {
        return perfisDefinitivo;
    }

    public void setPerfisDefinitivo(List<Perfil> perfisDefinitivo) {
        this.perfisDefinitivo = perfisDefinitivo;
    }
