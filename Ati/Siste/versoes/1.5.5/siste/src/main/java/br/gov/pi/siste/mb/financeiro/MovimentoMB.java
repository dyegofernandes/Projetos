            ...
            if (getEntity().getTipo() == TipoPessoa.PF) {
                if (getEntity().getIr() != null) {
                    ...
                    if (getEntity().getServidor() != null) {
                        if (getEntity().getServidor().getDadosFuncionais().getQtdDepIr() != null) {
                            valor = valor.subtract(getEntity().getIr().getDeducaoPorDependentes().
                                    multiply(new BigDecimal(getEntity().getServidor().getDadosFuncionais().getQtdDepIr())));
                        }
                    }
