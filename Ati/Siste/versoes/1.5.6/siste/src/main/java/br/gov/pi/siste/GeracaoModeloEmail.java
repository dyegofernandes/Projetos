...
public class GeracaoModeloEmail {
    ...
    public void generate() {
        ...
        salvarModeloEmail("[sca] Cadastro de Usuario", TipoAssuntoEmail.NOVO_USUARIO_SISTEMA, configuracaoEmail);
        salvarModeloEmail("[sca] Recuperacao de Senha", TipoAssuntoEmail.RECUPERACAO_SENHA, configuracaoEmail);
    }
