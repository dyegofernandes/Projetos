...
public class AliquotaIRRFBO extends AbstractBusinessObject<AliquotaIRRF> {
    ...
    public AliquotaIRRF aliquotaPeloValor(TabelaIRRF tabela, BigDecimal baseCalculo) {
        Restrictions restrictions = new Restrictions();
        ...
        AliquotaIRRF aliquota = getDAO().unique(restrictions);

        return getDAO().getInitialized(aliquota);
    }
