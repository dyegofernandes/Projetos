package br.gov.pi.ati.sccd.maker;

import br.gov.pi.ati.sccd.mb.padrao.ClassMB;
...
public class Maker extends MakerSwingFrame {
    ...
    public String getDefaultPackage() {
        return "br.gov.pi.ati.sccd.modelo";
    }
    ...
    public String getDefaultBaseDAOImpl() {
        return "br.gov.pi.ati.sccd.application.BaseDAOImpl";
    }
