package br.gov.pi.ati.sccd.modelo.configuracao;

import br.gov.pi.ati.sccd.constante.Constantes;
...
public class ErroSistema implements Serializable {
    ...
    private static final String PACOTE_PADRAO_SISTEMA = "br.gov.pi.ati.sccd";
