package br.gov.pi.ati.sisdh.maker;

import br.gov.pi.ati.sisdh.mb.padrao.ClassMB;
...
public class Maker extends MakerSwingFrame {
    ...
    public String getDefaultPackage() {
        return "br.gov.pi.ati.sisdh.modelo";
    }
    ...
    public String getDefaultBaseDAOImpl() {
        return "br.gov.pi.ati.sisdh.application.BaseDAOImpl";
    }
