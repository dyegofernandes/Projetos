package br.com.pagcontascarne.maker;

import br.com.pagcontascarne.mb.padrao.ClassMB;
...
public class Maker extends MakerSwingFrame {
    ...
    public String getDefaultPackage() {
        return "br.com.pagcontascarne.modelo";
    }
    ...
    public String getDefaultBaseDAOImpl() {
        return "br.com.pagcontascarne.application.BaseDAOImpl";
    }
