...
public class GeracaoModeloEmail {
    ...
    public void generate() {
        ...
        String email = "facilpagar@gmail.com";
        ...
        if (configuracaoEmail == null) {
            ...
            configuracaoEmail.setNome("[facilpagar]");
        ...
        salvarModeloEmail("[facilpagar] Cadastro de Usuario", TipoAssuntoEmail.NOVO_USUARIO_SISTEMA, configuracaoEmail);
        salvarModeloEmail("[facilpagar] Recuperacao de Senha", TipoAssuntoEmail.RECUPERACAO_SENHA, configuracaoEmail);
    }
