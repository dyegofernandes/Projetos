...
public class ConvenioBO extends AbstractBusinessObject<Convenio> {
    ...
    public List<Convenio> convenioPelaFranquia(Franquia franquia) {
        ...
        return getDAO().getQueryBuilder().select("convenio").from(Convenio.class, "convenio").leftJoinFetch("convenio.franquia", "franquia").add(restrictions)
                .orderBy("convenio.nome_fantasia").getResultList();
    }
    ...
    public List<Convenio> convenios(FiltrosBusca filtros) {
        ...
        return getDAO().getQueryBuilder().select("convenio").from(Convenio.class, "convenio").leftJoinFetch("convenio.franquia", "franquia").leftJoinFetch("convenio.categoria", "categoria").leftJoinFetch("convenio.cidade", "cidade")
