package br.com.facilpagar.maker;

import br.com.facilpagar.mb.padrao.ClassMB;
...
public class Maker extends MakerSwingFrame {
    ...
    public String getDefaultPackage() {
        return "br.com.facilpagar.modelo";
    }
    ...
    public String getDefaultBaseDAOImpl() {
        return "br.com.facilpagar.application.BaseDAOImpl";
    }
