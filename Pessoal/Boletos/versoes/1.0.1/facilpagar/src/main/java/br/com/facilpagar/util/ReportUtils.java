package br.com.facilpagar.util;
...
public class ReportUtils {
    ...
    public static final String TITULO = "SISTEMA [facilpagar]";
    public static final String SUBTITULO = "Subtítulo do Sistema [facilpagar]";
