...
@ManagedBean
@ViewScoped
public class RelatorioContasAPagarMB implements Serializable {
    ...
    public void init() {
        ...
        contasAPagar = contasAPagarBO.getDAO().relatorioVencimento(null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, OrdenacaoContasAPagar.FORNECEDOR_VENCIMENTO, TipoDeBusca.EM_ABERTO);
    }
    ...
    public void buscar() {
        contasAPagar = contasAPagarBO.getDAO().relatorioVencimento(filtros.getVencimentoInicial(), filtros.getVencimentoFinal(), filtros.getEntradaInicial(), filtros.getEntradaFinal(),
                ...
                null, null, null, filtros.getTituloVencimento(), filtros.getOrdenacao() != null ? filtros.getOrdenacao() : OrdenacaoContasAPagar.FORNECEDOR_VENCIMENTO, TipoDeBusca.EM_ABERTO);
    }
