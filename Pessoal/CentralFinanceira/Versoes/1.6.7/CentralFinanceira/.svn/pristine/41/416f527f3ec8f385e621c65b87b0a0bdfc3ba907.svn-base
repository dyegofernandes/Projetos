...
@ManagedBean
@ViewScoped
public class RelatorioContasAPagarCanceladasMB implements Serializable {
    ...
    public void init() {
        ...
        contasAPagar = contasAPagarBO.getDAO().relatorioVencimento(null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, OrdenacaoContasAPagar.FORNECEDOR_CANCELAMENTO, TipoDeBusca.CANCELADADAS);
    }
    ...
    public void buscar() {
        contasAPagar = contasAPagarBO.getDAO().relatorioVencimento(filtros.getVencimentoInicial(), filtros.getVencimentoFinal(), filtros.getEntradaInicial(), filtros.getEntradaFinal(),
                ...
                null, null, null, filtros.getTituloVencimento(), filtros.getOrdenacao() != null ? filtros.getOrdenacao() : OrdenacaoContasAPagar.FORNECEDOR_CANCELAMENTO, TipoDeBusca.CANCELADADAS);
    }
