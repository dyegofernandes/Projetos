...
public class Conveniocredigi implements Serializable {
    ...
    @NotAudited
    @OneToMany(mappedBy = "conveniocredigi")
    private List<ComissaoCreditoGrupoLoja> comissoes;
    ...
    public List<ComissaoCreditoGrupoLoja> getComissoes() {
        return comissoes;
    }

    public void setComissoes(List<ComissaoCreditoGrupoLoja> comissoes) {
