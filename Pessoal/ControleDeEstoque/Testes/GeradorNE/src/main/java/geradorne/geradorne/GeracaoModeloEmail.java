...
public class GeracaoModeloEmail {
    ...
    public void generate() {
        ...
        if (configuracaoEmail == null) {
            ...
            configuracaoEmail.setNome("[GeradorNE]");
        ...
        salvarModeloEmail("[GeradorNE] Cadastro de Usuario", TipoAssuntoEmail.NOVO_USUARIO_SISTEMA, configuracaoEmail);
        salvarModeloEmail("[GeradorNE] Recuperacao de Senha", TipoAssuntoEmail.RECUPERACAO_SENHA, configuracaoEmail);
    }
