package geradorne.geradorne.maker;

import geradorne.geradorne.mb.padrao.ClassMB;
...
public class Maker extends MakerSwingFrame {
    ...
    public String getDefaultPackage() {
        return "geradorne.geradorne.modelo";
    }
    ...
    public String getDefaultBaseDAOImpl() {
        return "geradorne.geradorne.application.BaseDAOImpl";
    }
