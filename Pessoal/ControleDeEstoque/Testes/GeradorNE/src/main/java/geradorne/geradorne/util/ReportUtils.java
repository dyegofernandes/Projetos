package geradorne.geradorne.util;
...
public class ReportUtils {
    ...
    public static final String TITULO = "SISTEMA [GeradorNE]";
    public static final String SUBTITULO = "Subtítulo do Sistema [GeradorNE]";
