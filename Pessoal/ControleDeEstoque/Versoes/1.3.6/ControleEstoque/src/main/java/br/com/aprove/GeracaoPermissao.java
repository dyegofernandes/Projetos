...
import br.com.aprove.dao.controleacesso.PermissaoDAO;
...
public class GeracaoPermissao {
    ...
    public void generate() {
        ...
        create(new Permissao("pais.create", "Cadastro de Pais", "/view/cadastro/pais/createPais.jsf", false), "pais");
        create(new Permissao("pais.list", "Paises", "/view/cadastro/pais/listPais.jsf", true), "cep");
        ...
        create(new Permissao("convenio", "Convênio - pai", false), "cadastrosnecessarios");
        create(new Permissao("convenio.create", "Cadastro de Convênio", "/view/cadastro/convenio/createConvenio.jsf", false), "convenio");
        create(new Permissao("convenio.list", "Convênios", "/view/cadastro/convenio/listConvenio.jsf", true), "cadastrosnecessarios");
...
//Fornecedor
        create(new Permissao("fornecedor", "Fornecedor - pai", false), "cadastrosbasicos");
        ...
        create(new Permissao("fornecedor.list", "Fornecedores", "/view/cadastro/fornecedor/listFornecedor.jsf", true), "cadastrosbasicos");
...
//Grupos De Secoes
        create(new Permissao("gruposDeSecoes", "Grupos De Secoes - pai", false), "cadastrosnecessarios");
        create(new Permissao("gruposDeSecoes.create", "Cadastro de Grupos De Secoes", "/view/cadastro/gruposDeSecoes/createGruposDeSecoes.jsf", false), "gruposDeSecoes");
        create(new Permissao("gruposDeSecoes.list", "Grupos De Secões", "/view/cadastro/gruposDeSecoes/listGruposDeSecoes.jsf", true), "cadastrosnecessarios");
...
//Produto
        create(new Permissao("produto", "Produto - pai", false), "cadastrosbasicos");
        create(new Permissao("produto.create", "Cadastro de Produto", "/view/cadastro/produto/createProduto.jsf", false), "produto");
        create(new Permissao("produto.list", "Produtos", "/view/cadastro/produto/listProduto.jsf", true), "cadastrosbasicos");
...
//Grupo Loja
        create(new Permissao("grupoLoja", "Grupo Loja - pai", false), "cadastrosnecessarios");
        create(new Permissao("grupoLoja.create", "Cadastro de Grupo Loja", "/view/cadastro/grupoLoja/createGrupoLoja.jsf", false), "grupoLoja");
        create(new Permissao("grupoLoja.list", "Grupos de Loja", "/view/cadastro/grupoLoja/listGrupoLoja.jsf", true), "cadastrosnecessarios");
...
//Secoes Produto
        create(new Permissao("secoesProduto", "Secoes Produto - pai", false), "cadastrosnecessarios");
        create(new Permissao("secoesProduto.create", "Cadastro de Secoes Produto", "/view/cadastro/secoesProduto/createSecoesProduto.jsf", false), "secoesProduto");
        create(new Permissao("secoesProduto.list", "Secões de Produto", "/view/cadastro/secoesProduto/listSecoesProduto.jsf", true), "cadastrosnecessarios");
...
//Loja Filial
        create(new Permissao("loja_Filial", "Empresa - pai", false), "cadastrosbasicos");
        create(new Permissao("loja_Filial.create", "Cadastro de Empresa", "/view/cadastro/loja_Filial/createLoja_Filial.jsf", false), "loja_Filial");
        create(new Permissao("loja_Filial.list", "Empresas", "/view/cadastro/loja_Filial/listLoja_Filial.jsf", true), "cadastrosbasicos");
        ...
        //Banco
        create(new Permissao("banco", "Banco - pai", false), "cadastrosnecessarios");
        create(new Permissao("banco.create", "Cadastro de Banco", "/view/cadastro/banco/createBanco.jsf", false), "banco");
        create(new Permissao("banco.list", "Bancos", "/view/cadastro/banco/listBanco.jsf", true), "cadastrosnecessarios");
        create(new Permissao("banco.audit", "Auditoria de Banco"), "banco");
        create(new Permissao("banco.delete", "Exclusão de Banco"), "banco");

        //Conta Bancaria
        create(new Permissao("contaBancaria", "Conta Bancaria - pai", false), "cadastrosnecessarios");
        create(new Permissao("contaBancaria.create", "Cadastro de Conta Bancaria", "/view/cadastro/contaBancaria/createContaBancaria.jsf", false), "contaBancaria");
        create(new Permissao("contaBancaria.list", "Contas Bancarias", "/view/cadastro/contaBancaria/listContaBancaria.jsf", true), "cadastrosnecessarios");
        ...
        create(new Permissao("naturezasDeOperacoes", "Naturezas de Operações - pai", false), "cadastrosnecessarios");
        create(new Permissao("naturezasDeOperacoes.create", "Cadastro de de Operações", "/view/cadastro/naturezasDeOperacoes/createNaturezasDeOperacoes.jsf", false), "naturezasDeOperacoes");
        create(new Permissao("naturezasDeOperacoes.list", "Operações", "/view/cadastro/naturezasDeOperacoes/listNaturezasDeOperacoes.jsf", true), "cadastrosnecessarios");
        ...
        create(new Permissao("pedido", "Pedidos/Entrada - pai", false), "faturamento");
        create(new Permissao("pedido.create", "Cadastro de Pedido/Entrada", "/view/faturamento/pedido/createPedido.jsf", false), "pedido");
        create(new Permissao("pedido.list", "Pedidos/Entradas", "/view/faturamento/pedido/listPedido.jsf", true), "faturamento");
        ...
        //Estoque
        create(new Permissao("estoque", "Estoque - pai", false), "faturamento");
        create(new Permissao("estoque.create", "Cadastro de Estoque", "/view/faturamento/estoque/createEstoque.jsf", false), "estoque");
        create(new Permissao("estoque.list", "Estoque", "/view/faturamento/estoque/listEstoque.jsf", true), "faturamento");
        ...
        //Venda
        create(new Permissao("venda", "Venda - pai", false), "faturamento");
        create(new Permissao("venda.create", "Cadastro de Venda", "/view/faturamento/venda/createVenda.jsf", false), "venda");
        create(new Permissao("venda.list", "Vendas", "/view/faturamento/venda/listVenda.jsf", true), "faturamento");
        create(new Permissao("venda.audit", "Auditoria de Venda"), "venda");
        create(new Permissao("venda.delete", "Exclusão de Venda"), "venda");

        //Nota Fiscal
        create(new Permissao("notaFiscal", "Nota Fiscal - pai", false), "faturamento");
        create(new Permissao("notaFiscal.create", "Cadastro de Nota Fiscal", "/view/faturamento/notaFiscal/createNotaFiscal.jsf", false), "notaFiscal");
        create(new Permissao("notaFiscal.list", "Notas Fiscais", "/view/faturamento/notaFiscal/listNotaFiscal.jsf", true), "faturamento");
...
//Lote Envio
        create(new Permissao("loteEnvio", "Lote Envio - pai", false), "faturamento");
        create(new Permissao("loteEnvio.create", "Cadastro de Lote Envio", "/view/faturamento/loteEnvio/createLoteEnvio.jsf", false), "loteEnvio");
        create(new Permissao("loteEnvio.list", "Lotes de Envio", "/view/faturamento/loteEnvio/listLoteEnvio.jsf", true), "faturamento");
        create(new Permissao("loteEnvio.audit", "Auditoria de Lote Envio"), "loteEnvio");
        create(new Permissao("loteEnvio.delete", "Exclusão de Lote Envio"), "loteEnvio");
        
        create(new Permissao("campos", "Campos", false), null);
        create(new Permissao("campos.matriz", "Campo matriz"), "campos");
        create(new Permissao("campos.filial", "Campo filial"), "campos");
