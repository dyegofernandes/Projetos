package br.com.aprove.bo.controleacesso;

import br.com.aprove.util.SessaoUtils;
import br.com.aprove.dao.controleacesso.HistoricoSituacaoUsuarioDAO;
...
public class UsuarioBO extends AbstractBusinessObject<Usuario> {
    ...
    public void validate(Usuario usuario) throws BusinessException {
        if (!usuario.isSuperUsuario() && usuario.getMatriz() == null) {
            throw new BusinessException("A Matriz é obrigatória!");
        }
    }
