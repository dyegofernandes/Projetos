...
import br.com.aprove.dao.faturamento.VendaDAO;
...
import br.com.aprove.vo.NETexto.ConstruirTxt;
import br.com.aprove.vo.NETexto.Nfe_Confins;
import br.com.aprove.vo.NETexto.Nfe_Dados;
import br.com.aprove.vo.NETexto.Nfe_Icms;
import br.com.aprove.vo.NETexto.Nfe_Identificacao;
import br.com.aprove.vo.NETexto.Nfe_IdentificacaoDestinario;
import br.com.aprove.vo.NETexto.Nfe_IdentificacaoEmitente;
import br.com.aprove.vo.NETexto.Nfe_InformacoesAdicionais;
import br.com.aprove.vo.NETexto.Nfe_InformacoesTransporte;
import br.com.aprove.vo.NETexto.Nfe_Issqn;
import br.com.aprove.vo.NETexto.Nfe_Pis;
import br.com.aprove.vo.NETexto.Nfe_ProdutosServicos;
import br.com.aprove.vo.NETexto.Nfe_ValoresTotais;
...
public class VendaBO extends AbstractBusinessObject<Venda> {
    ...
    public String gerarTxtNota(Venda venda, String numNota, String numChaveAcesso) {
        ...
        SituacaoTributaria situacaoTributaria = vendaDAO.getInitialized(empresa.getSituacaoTributaria());
...
//   ------------------ Fim Grupo B ----------------------
        ...
        if (venda.getCliente().getTipoDePessoa() == TipoDePessoa.JURIDICA) {
            ...
            e.setE04Xnome(venda.getCliente().getRazaoSocial().toUpperCase());
            e.setE03Cpf(venda.getCliente().getCnpj());
        }
        ...
        for (ItemVenda item : list) {
            ...
            i.setI02Cprod(String.valueOf(item.getEstoque().getId()));
//            i.setI03Cean(prod.getProEan().replace("-", ""));  // nao sei o que eh
            Produto produto = getDAO().getInitialized(item.getEstoque().getProduto());
            i.setI04Xprod(produto.getDescricao().toUpperCase());
            i.setI05Ncm(produto.getCodigoNCM());
            i.setI08Cfop(venda.getCfop());
...
//            i.setI17Vdesc(formatarDouble(desconto).replace(",", ".")+"00");  //Nao sei o que eh
            ...
            //GRUPO N  
            n = gerarTributacao(venda.getCodigoCst().substring(1, 4), venda.getCodigoCst().substring(0, 1), venda.getCodigoCst(), String.valueOf(situacaoTributaria.getCodigo()));
...
//        z.setZ03Infcpl("DADOS BANCARIOS: AG.: " + conta.getAgencia() + "CNTA CORRENTE: " + conta.getConta() + ", " + conta.getBanco().getNome() + "-" + conta.getBanco().getSigla());
    ...
    public void gerarOrcamento(Venda item) {
        ...
        params.put("nomeCliente", cliente.getRazaoSocial());
        ...
        params.put("textoObs", item.getCampoComplementar() != null ? item.getCampoComplementar() : getText2());
        ...
        FacesJasper.createJasperReport(listaVO, params,
                "/WEB-INF/report/relatorios/orcamento.jasper", "Orcamento - ".concat(cliente.getRazaoSocial()).concat(".pdf"));
...
//            itemNovo.setIpi(item.getIpi());
            itemNovo.setEstoque(item.getEstoque());
    ...
    public void save(Venda object) throws BusinessException {
        ...
        String cnpjNome = (cliente.getNomeFantasia() + ", Data: "
