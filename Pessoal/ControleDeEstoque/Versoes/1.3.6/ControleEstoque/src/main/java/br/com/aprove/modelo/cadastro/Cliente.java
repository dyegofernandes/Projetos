...
public class Cliente implements Serializable {
    ...
    @NotNull
    private TipoDePessoa tipoDePessoa = TipoDePessoa.JURIDICA;
    ...
    public String getCnpj() {
        return tipoDePessoa == TipoDePessoa.JURIDICA ? format("##.###.###/####-##", cnpj) : format("###.###.###-##", cnpj);
    }
    ...
    public String toString() {
        return tipoDePessoa == TipoDePessoa.JURIDICA ? format("##.###.###/####-##", cnpj) + " - " + razaoSocial : format("###.###.###-##", cnpj) + " - " + razaoSocial;
    }
