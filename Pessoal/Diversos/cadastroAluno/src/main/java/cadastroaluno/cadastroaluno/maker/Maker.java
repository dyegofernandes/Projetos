package cadastroaluno.cadastroaluno.maker;

import cadastroaluno.cadastroaluno.mb.padrao.ClassMB;
...
public class Maker extends MakerSwingFrame {
    ...
    public String getDefaultPackage() {
        return "cadastroaluno.cadastroaluno.modelo";
    }
    ...
    public String getDefaultBaseDAOImpl() {
        return "cadastroaluno.cadastroaluno.application.BaseDAOImpl";
    }
