package cadastroaluno.cadastroaluno.modelo.configuracao;

import cadastroaluno.cadastroaluno.constante.Constantes;
...
public class ErroSistema implements Serializable {
    ...
    private static final String PACOTE_PADRAO_SISTEMA = "cadastroaluno.cadastroaluno";
