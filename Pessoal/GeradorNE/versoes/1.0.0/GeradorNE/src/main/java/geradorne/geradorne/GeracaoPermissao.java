...
import geradorne.geradorne.dao.controleacesso.PermissaoDAO;
...
public class GeracaoPermissao {
    ...
    public void generate() {
        ...
        create(new Permissao("notaFiscal", "NotaFiscal", true), null);
        ...
        create(new Permissao("notaFiscal.geraNotaFiscal", "Gerar NotaFiscal", "/view/notaFiscal/gerarNotaFiscal.jsf", true), "notaFiscal");
