...
import br.com.politicalpartysystem.dao.DAO;
...
public class GeracaoModeloEmail {
    ...
    public void generate() {
        ...
        if (configuracaoEmail == null) {
            ...
            configuracaoEmail.setNome("[politicalPartySystem]");
        ...
        salvarModeloEmail("[politicalPartySystem] Cadastro de Usuario", TipoAssuntoEmail.NOVO_USUARIO_SISTEMA, configuracaoEmail);
        salvarModeloEmail("[politicalPartySystem] Recuperacao de Senha", TipoAssuntoEmail.RECUPERACAO_SENHA, configuracaoEmail);
    }
