...
import br.com.weblicita.modelo.email.ConfiguracaoEmail;
...
import br.com.weblicita.modelo.email.ModeloEmail;
import br.com.weblicita.modelo.controleacesso.SolicitacaoRecuperacaoSenha;
import br.com.weblicita.modelo.email.TipoAssuntoEmail;
...
public class ClassMB {
    ...
    public Class getAdministradorFornecedor() {
        return AdministradorFornecedor.class;
    }
    ...
    public Class getTipoDeSocio() {
        return TipoDeSocio.class;
    }

    public Class getItemLicitacao() {
        return Item.class;
    }

    public Class getUnidadeItem() {
        return UnidadeItem.class;
    }
    ...
    public Class getPedidoLicitacao() {
        return PedidoLicitacao.class;
    }

    public Class getRubricaOrcamentaria() {
        return RubricaOrcamentaria.class;
    }

    public Class getSituacaoPedidoLicitacao() {
        return SituacaoPedidoLicitacao.class;
    }

    public Class getTipoModalidade() {
    ...
    public Class getLicitante() {
        return Licitante.class;
    }
    public Class getPesquisaDePreco() {
