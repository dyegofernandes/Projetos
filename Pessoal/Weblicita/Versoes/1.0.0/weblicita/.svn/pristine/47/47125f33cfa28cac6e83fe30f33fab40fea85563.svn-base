 ...
 */
@Entity
public class Licitante implements Serializable {

    @Id
    @SequenceGenerator(name = "Licitante", allocationSize = 1, sequenceName = "licitante_id_seq")
    @GeneratedValue(generator = "Licitante")
    private Long id;
...
//    @NotNull
    ...
    public boolean equals(Object obj) {
        ...
        final Licitante other = (Licitante) obj;
