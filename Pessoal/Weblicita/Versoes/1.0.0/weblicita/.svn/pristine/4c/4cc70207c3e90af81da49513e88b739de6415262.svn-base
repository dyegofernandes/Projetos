...
//Estado
        ...
        create(new Permissao("pais.list", "Países", "/view/cadastro/pais/listPais.jsf", true), "cadastro");
...
//Item
        ...
        create(new Permissao("rubricaOrcamentaria.list", "Rúbricas Orcamentárias", "/view/cadastro/rubricaOrcamentaria/listRubricaOrcamentaria.jsf", true), "cadastro");
        ...
        create(new Permissao("pedidoLicitacao.create", "Cadastro de Pedido Licitação", "/view/licitacao/pedidoLicitacao/createPedidoLicitacao.jsf", false), "pedidoLicitacao");
        create(new Permissao("pedidoLicitacao.list", "Pedidos Licitações", "/view/licitacao/pedidoLicitacao/listPedidoLicitacao.jsf", true), "licitacao");
        ...
        create(new Permissao("contrato.create", "Cadastro de Contrato", "/view/contrato/contrato/createContrato.jsf", false), "contrato");
