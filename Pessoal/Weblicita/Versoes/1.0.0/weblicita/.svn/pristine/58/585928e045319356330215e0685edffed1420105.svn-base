...
//Item
        ...
        create(new Permissao("pesquisaDePreco.create", "Cadastro de Pesquisa De Preco", "/view/licitacao/pesquisaDePreco/createPesquisaDePreco.jsf", true), "licitacao");
        create(new Permissao("pesquisaDePreco.list", "Pesquisas de Preços", "/view/licitacao/pesquisaDePreco/listPesquisaDePreco.jsf", false), "pesquisaDePreco");
