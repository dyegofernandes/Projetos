...
public class GeracaoPermissao {
    ...
    public void generate() {
        ...
        create(new Permissao("usuario.create", "Usuários", "/view/controleAcesso/usuario/createUsuario.jsf", true), "controleAcesso");
        create(new Permissao("usuario.list", "Consulta de Usuário", "/view/controleAcesso/usuario/listUsuario.jsf", false), "usuario");
        ...
        create(new Permissao("usuario.editar", "Editar de Usuário"), "usuario");
        create(new Permissao("usuario.ativar", "Ativar de Usuário"), "usuario");
        create(new Permissao("usuario.desativar", "Desativar de Usuário"), "usuario");
