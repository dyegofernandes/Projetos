...
public class GeracaoModeloEmail {
    ...
    public void generate() {
        ...
        String email = "pagcontascarne@gmail.com";
        ...
        if (configuracaoEmail == null) {
            ...
            configuracaoEmail.setNome("[pagcontascarne]");
            configuracaoEmail.setEmail(email);
            configuracaoEmail.setUsuario(email);
            configuracaoEmail.setSenha("Sistema123");
        ...
        salvarModeloEmail("[pagcontascarne] Cadastro de Usuario", TipoAssuntoEmail.NOVO_USUARIO_SISTEMA, configuracaoEmail);
        salvarModeloEmail("[pagcontascarne] Recuperacao de Senha", TipoAssuntoEmail.RECUPERACAO_SENHA, configuracaoEmail);
    }
