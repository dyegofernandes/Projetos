...
public class BoletoVO implements Serializable {
    ...
    public BoletoVO(String numeroDocumento, Long nossoNumero, Date vencimento, BigDecimal valorDocumento,
            BigDecimal multa, BigDecimal desconto, String pagador, String localPagamento,
            Date dataDocumento, String instrucoes, String referenteA,
            String enderecoPagador, String linhaDigitavel, String codigoBarras) {
        this.beneficiario = "PagContas Carnês - Endereço do PagContas Carnês";
        this.agenciaBeneficiario = "Agência de Depósito do PagContas Carnês";
        ...
        this.valorDocumento = valorDocumento.toString();
        this.desconto = desconto.toString(); // Texto: "Conceder desconto de R$ boleto.vl_desconto até o vencimento!" A ser exibido na área de instruções 
        this.descontoTexto = "Conceder desconto de R$ " + desconto + " boleto.vl_desconto até o vencimento!";
        ...
        this.multa = multa.toEngineeringString(); // Texto: "Cobrar multa de R$ boleto.vl_multa após o vencimento."
        this.multaTexto = "Cobrar multa de R$ " + multa + " boleto.vl_multa após o vencimento.";
